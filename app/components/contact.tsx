      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="mb-8 text-gray-400">
            Interested in STEM education collaboration or discussing robotics projects? Let's connect and inspire young
            minds together.
          </p>
          <div className="mb-8 space-y-2 text-sm text-gray-300">
            <p> katminh.dev@gmail.com</p>
            <p> 0394629319</p>
            <p> 186, Đ. 154, Long Thạnh Mỹ, Thủ Đức, TP HCM</p>
            <p> FPT University Ho Chi Minh - Software Engineering</p>
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
